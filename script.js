...
function allTextsChildrens() {
    return [
        ...
        "Noi possiamo fare la nostra parte per aiutare questi bambini e famiglie nel loro viaggio.<br><br>Donando a <a class='linkText' href='https://www.savethechildren.it'>Save the Children</a>, possiamo contribuire a rendere il mondo un posto migliore e pi<span class='charSpecial'>ù</span> sicuro per tutti.",
